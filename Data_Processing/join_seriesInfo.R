...
cleanUp(seriesInfo$Description.1) <- 10
cleanUp(seriesInfo$Description.2) <- 10
cleanUp(seriesInfo$Description.3) <- 10
...
# Export all series information -------------------------------------------

write.csv(seriesInfo,'Data/seriesInfo.csv',row.names=FALSE)
